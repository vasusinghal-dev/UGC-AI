...
export default function Hero() {
  ...
  const galleryStripImages = [
    "https://images.unsplash.com/photo-1545239351-1141bd82e8a6?q=80&w=100",
    "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=100",
    "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&w=100",
  ];

  const trustedLogosText = ["Adobe", "Canva", "Spotify", "Shopify", "Webflow"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="text-left">
              ...
              >
                ...
                optimized for commercials and Reels.
              </motion.p>
